...
fun main() {
    ...
    var map: Map<Int, Int> = mapOf(Pair(5,15))

    println(mutableMap.contains("Anderson"))
    mutableMap["Anderson"] = "aluno"
    println(mutableMap.contains("Anderson"))
    mutableMap.put("Anderson", "aluno ebac")
    println(mutableMap.get("Anderson"))
